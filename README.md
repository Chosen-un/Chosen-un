...
<img loading="lazy" src="https://skillicons.dev/icons?i=python,java,javascript,sql,pytorch,tensorflow,huggingface,keras,sklearn,openai,langchain,react" alt="languages-frameworks-tools" /><br />
